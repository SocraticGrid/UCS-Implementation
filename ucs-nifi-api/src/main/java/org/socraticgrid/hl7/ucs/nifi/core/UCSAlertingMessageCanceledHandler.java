 ...
 * @author esteban
 */
public class UCSAlertingMessageCanceledHandler extends UCSAlertingBaseHandler{

    private static final Logger LOG = LoggerFactory.getLogger(UCSAlertingMessageCanceledHandler.class);

    public UCSAlertingMessageCanceledHandler(UCSAlertingIntf listener) {
        super(listener);
    }
    ...
    public void handle(HttpExchange he) throws IOException {
        try{
            ...
            this.getListener().cancelAlertMessage(model, localReceivers, serverId);
