 ...
 * @author esteban
 */
public class UCSClientResponseHandler extends UCSClientBaseHandler{

    private static final Logger LOG = LoggerFactory.getLogger(UCSClientResponseHandler.class);

    public UCSClientResponseHandler(UCSClientIntf listener) {
        super(listener);
    }
    ...
    public void handle(HttpExchange he) throws IOException {
        try{
            ...
            try {
                this.getListener().handleResponse(new MessageModel(messageWrapper.getMessage()), serviceId);
            } catch (Exception ex) {
