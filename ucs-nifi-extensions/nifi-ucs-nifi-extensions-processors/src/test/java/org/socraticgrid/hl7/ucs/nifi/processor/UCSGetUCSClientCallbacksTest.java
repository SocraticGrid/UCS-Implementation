 ...
 * @author esteban
 */
public class UCSGetUCSClientCallbacksTest extends UCSControllerServiceBasedTest{
    ...
    public void testNoRegisteredCallbacks(){
        ...
        testRunner.setProperty(UCSGetUCSClientCallbacks.REMOVE_PROTOCOL_FROM_URL, "false");
        
        testRunner.enqueue(new byte[]{});
        testRunner.run();
        
        testRunner.assertAllFlowFilesTransferred(UCSGetUCSClientCallbacks.REL_EMPTY, 1);
    }
    ...
    public void testSingleRegisteredCallback() throws MalformedURLException{
        ...
        MockFlowFile flowFile = testRunner.getFlowFilesForRelationship(UCSGetUCSClientCallbacks.REL_SUCCESS).get(0);
    ...
    public void testMultipleRegisteredCallback() throws MalformedURLException{
        ...
        controller.registerUCSClientCallback(new URL("http://localhost:8080/App/listener"));
        controller.registerUCSClientCallback(new URL("https://localhost:8080/OtherApp/listener"));
        ...
        testRunner.assertAllFlowFilesTransferred(UCSGetUCSClientCallbacks.REL_SUCCESS, 2);
        Set<String> callbacks = testRunner.getFlowFilesForRelationship(UCSGetUCSClientCallbacks.REL_SUCCESS).stream()
